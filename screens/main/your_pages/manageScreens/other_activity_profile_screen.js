...
export class OtherActivityProfileScreen extends React.Component {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            viewing_admins: this.props.route.params.viewing_admins,
            activity_id: this.props.route.params.activity_id,
            name: "",
            age: 0,
            gender: "",
            description: "",
    ...
    componentDidMount() {
        //init
        GlobalProperties.return_screen = "Other Activity Profile Screen";
            ...
            if (this.state.viewing_admins) {
                ...
                inviteActions = (
                    <View>
                        ...
                        <View style={main_styles.horizontal_bar} />
                        <TouchableOpacity  style={actions_styles.actions_button} activeOpacity={GlobalValues.ACTIVE_OPACITY} onPress={() => {this.blockFromActivity();}}>
                            <Text style={actions_styles.action_button_text}>
                                Block
                            </Text>
                            <AntDesign name="right" size={20} color="black" style={actions_styles.action_button_icon}/>
    ...
    async kick() {
        ...
        //make request
        var result = await GlobalEndpoints.makeGetRequest(true, "/api/User/Friends/RemoveParticipantAsActivity?activity_id=" + this.state.activity_id + "&user_id=" + this.state.id)
            .then((result) => {
                if (result == undefined) {
                    successful = false;
                }
